           ...
           return new Pattern[]
            {
                ...
                new Pattern { BlockNumber = "1.3.2", Warning="U Turn", SeatLocation = "Pan", TactorSequence = "15->10->11" , Counter = 3, Sort = "6"},
                new Pattern { BlockNumber = "1.4.1", Warning="Speed Up", SeatLocation = "Belt", TactorSequence = "2,4", IsSimultaneous = true , Counter = 3, Sort = "7"},
                new Pattern { BlockNumber = "1.4.2", Warning="Speed Up", SeatLocation = "Pan", TactorSequence = "15,10", IsSimultaneous = true , Counter = 3, Sort = "8"},
                ...
                new Pattern { BlockNumber = "1.5.2", Warning="Left Turn", SeatLocation = "Pan", TactorSequence = "8,14", IsSimultaneous = true , Counter = 3, Sort = "10"},
                ...
                new Pattern { BlockNumber = "2.3.2", Warning="U Turn", SeatLocation = "Pan", TactorSequence = "15->10->11" , Counter = 3, Sort = "16" },
                new Pattern { BlockNumber = "2.4.1", Warning="Speed Up", SeatLocation = "Belt", TactorSequence = "2,4", IsSimultaneous = true , Counter = 3, Sort = "8" },
                new Pattern { BlockNumber = "2.4.2", Warning="Speed Up", SeatLocation = "Pan", TactorSequence = "15,10", IsSimultaneous = true , Counter = 3, Sort = "10" },
                ...
                new Pattern { BlockNumber = "2.5.2", Warning="Left Turn", SeatLocation = "Pan", TactorSequence = "8,14", IsSimultaneous = true , Counter = 3, Sort = "14" },
                ...
                new Pattern { BlockNumber="3.7.1", Warning="Pan back-to-front", SeatLocation="Pan(Left)", TactorSequence="14->11->10", Counter=3, Sort = "24" },
                new Pattern { BlockNumber="3.7.2", Warning="Pan back-to-front", SeatLocation="Pan(Right)", TactorSequence="8->16->15", Counter=3, Sort = "25" },
                ...
                new Pattern { BlockNumber="3.8.2", Warning="Speeding", SeatLocation="Pan", TactorSequence="16,11", IsSimultaneous=true, Counter=3, Sort = "27" },
                ...
                new Pattern { BlockNumber="4.7.1", Warning="Pan back-to-front", SeatLocation="Pan(Left)", TactorSequence="14->11->10", Counter=3, Sort = "34" },
                new Pattern { BlockNumber="4.7.2", Warning="Pan back-to-front", SeatLocation="Pan(Right)", TactorSequence="8->16->15", Counter=3, Sort = "35" },
                ...
                new Pattern { BlockNumber="4.8.2", Warning="Speeding", SeatLocation="Pan", TactorSequence="16,11", IsSimultaneous=true, Counter=3, Sort = "37" },
